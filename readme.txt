...
For the full release history of older versions, see [changelog.txt](https://plugins.svn.wordpress.org/brikpanel-admin-panel-dashboard-for-woocommerce/trunk/changelog.txt) bundled with the plugin.